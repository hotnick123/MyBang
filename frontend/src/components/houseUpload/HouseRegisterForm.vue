		...
		<v-stepper v-model="e6">
			<form @submit.prevent="onSubmit">
				...
				<v-stepper-content step="1">
					<v-card class="pa-5 mt-n5" flat>
						<v-radio-group v-model="serviceType" color="secondary" row>
							<v-radio value="villa" label="빌라"></v-radio>
							<v-radio value="oneroom" label="원룸"></v-radio>
				...
				<v-stepper-content step="2">
					...
					<v-btn class="my-3" text @click="e6 = 1">이전</v-btn>
					<v-btn class="my-3" color="secondary" @click="e6 = 3" :disabled="!completeAgentAddr">다음</v-btn>
				</v-stepper-content>


				<v-stepper-step color="secondary" :complete="e6 > 3" step="3">
					매물 입력사항(1)
				</v-stepper-step>
